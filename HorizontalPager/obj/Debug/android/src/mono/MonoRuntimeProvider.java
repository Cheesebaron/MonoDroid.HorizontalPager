	...
	extends android.content.ContentProvider
{
	...
	public void attachInfo (android.content.Context context, android.content.pm.ProviderInfo info)
	{
		...
		try {
			...
			android.content.pm.ApplicationInfo apiInfo = mono.MonoPackageManager_Resources.ApiPackageName != null
				? context.getPackageManager ().getApplicationInfo (mono.MonoPackageManager_Resources.ApiPackageName, 0)
				: null;
			...
			throw new RuntimeException ("Unable to find application Mono.Android.DebugRuntime" + 
					(mono.MonoPackageManager_Resources.ApiPackageName == null ? "" : " or " + mono.MonoPackageManager_Resources.ApiPackageName) +
					"!", e);
		}
		// }}}
